	        ...
	        <div class="alert alert-block">
	         ...
	         <div class="offset3 span6">
				<form action="/reservation/admin.do?flag=addStudent" method="post">
	        		...
	        		<input id="sno" class="border-radius-none" name="sno" type="text" placeholder="请填写账号" required="required"/>
	    			<span id="sno_tip" style="color:red;"></span>
	    			
	               	<label>初始化密码：</label>
	    			<input class="border-radius-none" name="spassword" type="password"  placeholder="请填写初始化密码" value="zjdxrjxy" required="required"/>                    
