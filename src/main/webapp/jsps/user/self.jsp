		...
		<div class="offset3 span6">
			<div class="headline">
         	...
         	<form action="/reservation/user.do?flag=updateSelf" method="post">
    			...
    			<label>密码</label>
    			<input class="border-radius-none" name="spassword" type="password" value="${student.spassword}" placeholder="请输入密码" required="required"/>
    			<input id="showpassword" type="button" class="btn" value="显示密码" />
	                
    			<label>组织名称</label>
    			<input class="border-radius-none" name="sname" type="text" value="${student.sname}" placeholder="请输入组织名称" required="required"/>
    		
    			<label>备注信息</label>
    			<textarea class="span12 border-radius-none" name="sremark" type="text">${student.sremark }</textarea>
    		
	    		<label>最近一次登入时间</label>
	    		<input class="border-radius-none" name="" type="text" value="${student.slastlogin }" readonly="readonly" />
	    		
    			<label>登入总次数</label>
    			<input class="border-radius-none" name="" type="text" value="${student.slogincount}" readonly="readonly" />
