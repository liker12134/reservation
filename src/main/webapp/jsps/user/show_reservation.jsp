	    		...
	    		<div class="service clearfix">
	    			...
	    			<div class="desc">
	                    ...
	                    <p>
	                    	...
	                    	<br/>
	                    	<span>
	                    		借用时间：<fmt:formatDate value="${res.tbegintime}" pattern="HH:mm"/> ~ <fmt:formatDate value="${res.tendtime}" pattern="HH:mm"/> 
	                    	</span>
	                    	<span>
	                    		具体时间：<fmt:formatDate value="${res.rspecificbegintime}" pattern="HH:mm"/> ~ <fmt:formatDate value="${res.rspecificendtime}" pattern="HH:mm"/> 
	                    	</span>
	                    </p>
	    			</div>
	    		</div>	
