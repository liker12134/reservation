    ...
    <div class="row-fluid">
        ...
        <div class="offset3 span6">
            <form action="/reservation/admin.do?flag=updateManager" method="post">
                ...
                <label>用户名：</label>
                <input class="border-radius-none" name="maccount" value="${manager.maccount}" type="text"
                       placeholder="请填写用户名"/>
                ...
                <label>管理员备注：</label>
                <textarea class="span12 border-radius-none" name="mremark" rows="6"
                          placeholder="请填写备注信息">${manager.mremark}</textarea>
