	        ...
	        <div class="alert alert-block">
	         ...
	         <div class="offset3 span6">
				<form action="/reservation/admin.do?flag=updateClass" method="post">
	        		...
	        		<label>教室名称：</label>
	        		<input class="border-radius-none" name="cname" value="${classDetail.cname}" type="text" placeholder="请填写教室名称" />
	    			    
	               	<label>最大容量：</label>
	    			<input class="border-radius-none" type="number" name="cmax" value="${classDetail.cmax}" placeholder="请填写最大容量" />                    
	                
	    			<label>备注信息：</label>
	    			<textarea class="span12 border-radius-none" name="cremark"  rows="6" placeholder="请填写备注信息">${classDetail.cremark}</textarea> 
