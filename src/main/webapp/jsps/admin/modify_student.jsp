	         ...
	         <div class="offset3 span6">
				<form action="/reservation/admin.do?flag=updateStudent" method="post">
	        		...
	        		<input class="border-radius-none" name="sno" value="${student.sno}" type="text" readonly="readonly" />
	               	...
	               	<label>初始化密码：</label>
	    			<input class="border-radius-none" name="spassword" value="${student.spassword}"  type="password"  placeholder="请填写初始化密码" />                    
	                <input id="showpassword" type="button" class="btn" value="显示密码" />
	            
	                <label>组织名称：</label>
	        		<input class="border-radius-none" name="sname" value="${student.sname}"  type="text" placeholder="请填写组织名称" />
	    			...
	    			<label>备注信息：</label>
	    			<textarea class="span12 border-radius-none" name="sremark"  rows="6" placeholder="请填写备注信息">${student.sremark}</textarea> 
